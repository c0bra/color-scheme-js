  ...
  ColorScheme = (function() {
    ...
    */
    ...
    ColorScheme.prototype.colorset = function() {
      ...
      flat_colors = _.cloneDeep(this.colors());
      grouped_colors = [];
      while (this.flat_colors.length > 0) {
    ...
    */
    ...
    ColorScheme.prototype.from_hex = function(hex) {
      var b, c, g, h, h0, h1, h2, hsv, hsv1, i, i1, i2, k, num, r, rgb2hsv, rgbcap, s, v, _j, _len1, _ref1, _ref2;
      if (hex == null) {
      ...
      s = null;
      v = null;
      _ref2 = _.keys(ColorScheme.COLOR_WHEEL).sort(function(a, b) {
        return a - b;
      });
      for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
        i = _ref2[_j];
    ...
    ColorScheme.mutablecolor = (function() {
      ...
      mutablecolor.prototype.set_hue = function(h) {
        ...
        _.each(en, function(i, color) {
          return _this["base_" + color] = avrg(colorset1[i], colorset2[i], k);
        });
      ...
      mutablecolor.prototype.get_hex = function(web_safe, variation) {
        ...
        rgb = _.map(['red', 'green', 'blue'], function(color) {
          var rgbVal;
          rgbVal = _.min([255, Math.round(v - (v - _this["base_" + color] * k) * s)]);
          return rgbVal;
        });
        if (web_safe) {
